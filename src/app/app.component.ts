...
export class AppComponent implements OnInit {
  ...
  onSquareFilled(point: Point) {
    if (this.isPointOutOfBounds(point, this.isFilled)) {
  ...
  onDrop() {
    const point = this.getPointFromEvent(this.mousePositionSubject.getValue());
    console.log(point);
  ...
  private setHover(point: Point) {
    if (this.isPointOutOfBounds(point, this.isHovered)) {
  ...
  private isPointOutOfBounds(point: Point, array: any[][]) {
    return (
